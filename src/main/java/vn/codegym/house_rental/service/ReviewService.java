...
public class ReviewService {
    ...
    public Page<Review> getReviewsByHouse(
            Long houseId,
            int page,
            int size) {
        ...
        return reviewRepository.findVisibleReviewsByHouseId(
                houseId,
                pageable
        );
    }

    public double getAverageRatingByHouse(Long houseId) {

        Double average =
                reviewRepository.getAverageRatingByHouseId(
                        houseId
                );
